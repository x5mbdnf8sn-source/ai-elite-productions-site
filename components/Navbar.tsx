  ...
  return (
    <nav className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 px-4 py-3">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        >
          <div className="w-10 h-10 bg-cyan-600 rounded-lg flex items-center justify-center font-black text-white text-xl shadow-lg shadow-cyan-900/20 group-hover:scale-110 transition-transform">
            E
          </div>
        ...
        <div className="hidden lg:flex items-center space-x-6 text-sm font-semibold text-slate-400">
          <button className="hover:text-cyan-400 transition cursor-pointer">NEW</button>
          <button className="hover:text-cyan-400 transition cursor-pointer">POPULAR</button>
          <button className="hover:text-cyan-400 transition cursor-pointer">ABOUT</button>
        </div>
      </div>
    </nav>
  );
